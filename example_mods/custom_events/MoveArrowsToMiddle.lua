...
function onEvent(name, value1, value2)
    if name == "MoveArrowsToMiddle" then
        ...
        if value2 == 1 then
            noteTweenAlpha('outtaHere1Tween', 0, 0, 0.01, 'linear')
            noteTweenAlpha('outtaHere2Tween', 1, 0, 0.01, 'linear')
            noteTweenAlpha('outtaHere3Tween', 2, 0, 0.01, 'linear')
            noteTweenAlpha('outtaHere4Tween', 3, 0, 0.01, 'linear')
        elseif value2 == 0 then
            noteTweenAlpha('noWaitComeBack1Tween', 0, 1, 0.01, 'linear')
            noteTweenAlpha('noWaitComeBack2Tween', 1, 1, 0.01, 'linear')
            noteTweenAlpha('noWaitComeBack3Tween', 2, 1, 0.01, 'linear')
            noteTweenAlpha('noWaitComeBack4Tween', 3, 1, 0.01, 'linear')
